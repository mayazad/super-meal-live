...
export default function MealDepositsPage() {
    ...
    return (
        <div className="space-y-8 max-w-4xl">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Meal Deposits</h1>
                    <p className="text-muted-foreground mt-1">
                        Log money deposited by members towards the shared Meal Fund.
                    </p>
                </div>
                    ...
                    <div className="rounded-xl border bg-card shadow-sm overflow-hidden">
                        {isLoading ? (
                            ...
                            <div className="p-12 text-center text-muted-foreground flex flex-col items-center">
                                ...
                                No meal deposits recorded for this month.
                            </div>
                        ) : (
